<template>
	<view class="flex custom-col-24">
		<view @tap="play" class="custom-avatar music-avatar radius margin-right-xs"
			...
			:style="style">
			<image v-if="avatarType=='img'" mode="aspectFit" class="custom-avatar-img radius" :src="poster"></image>
