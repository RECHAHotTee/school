<template>
	<view class="">
		<view class="u-navbar"  :style="[navbarStyle]" :class="[isFixed?'u-navbar-fixed':'',borderBottom?'u-border-bottom':'',bgColor]">
			...
			<view class="u-navbar-inner" :style="[navbarInnerStyle]">
				...
				<view class="u-back-wrap u-back-home" v-if="isHome" @tap="getHome">
					<view class="u-icon-wrap">
						<u-icon name="home" customPrefix="diy-icon" :color="backIconColor" :size="backIconSize"></u-icon>
					</view>
				</view>
				<view class="u-navbar-content-title" v-if="title||isSlotTitle" :style="[titleStyle]">
					<view
