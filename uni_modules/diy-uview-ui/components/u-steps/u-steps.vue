<template>
	<view class="custom-steps-wrap" >
		<view v-if="mode == 'diy'||mode=='number'" class="custom-steps" :class="[arrow?'steps-arrow':'']">
			<view class="custom-step-item" :class="[index > current ? '' : item.textClazz]" v-for="(item, index) in list" :key="index">
